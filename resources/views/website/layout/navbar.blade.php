...
<header class="header sticky top-0 bg-white shadow-md flex items-center justify-between h-16 z-50">
    ...
    <h1 class="w-3/12">
        <a href="">
            <svg viewBox="0 0 248 31" class="h-6 w-auto hover:text-blue-500 duration-200">
                <path
    ...
    <nav class="nav font-semibold text-lg">
        <div class="flex items-center gap-5 max-tablet:hidden">
            <div class="px-3 py-2 hover:bg-gray-600 hover:text-white hover:rounded-md hover:shadow-md">
                <a href="{{ url('/') }}">Home</a>
            </div>
            <div class="px-3 py-2 hover:bg-gray-600  hover:rounded-md hover:shadow-md group hover:text-white">
